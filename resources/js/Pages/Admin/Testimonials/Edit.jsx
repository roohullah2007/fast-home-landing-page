...
export default function Edit({ auth, testimonial }) {
    ...
    return (
        <AdminLayout
            header={<h1 className="text-2xl font-bold text-gray-900">Edit Testimonial</h1>}
        >
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h3 className="text-lg font-medium text-gray-900">Edit Testimonial Details</h3>
                                <Link
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-xs text-gray-500">Upload a new customer photo to replace the current one (JPG, PNG, GIF)</p>
                                    </div>
                                    ...
                                    <div className="lg:col-span-2">
                                        ...
                                        {testimonial.video_url && isFileVideo(testimonial.video_url) && (
                                            <div className="mt-2 mb-2">
                                                <video
                                                ...
                                                />
                                                <p className="text-xs text-gray-500 mt-1 break-all">Current video: {testimonial.video_url}</p>
                                            </div>
                                        )}
                                        <input
                                            type="file"
                                    ...
                                    <div className="lg:col-span-2">
                                        ...
                                        <p className="mt-1 text-xs text-gray-500">Paste a YouTube link or video path. Uploading a file above takes precedence. Clear this to remove the video.</p>
                                    </div>
