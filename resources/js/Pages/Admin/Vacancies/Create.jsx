...
export default function Create({ auth }) {
    ...
    return (
        <AdminLayout
            header={<h1 className="text-2xl font-bold text-gray-900">Create New Vacancy</h1>}
        >
            <Head title="Create New Vacancy" />
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h3 className="text-lg font-medium text-gray-900">Job Vacancy Details</h3>
                                <Link
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                                    ...
                                    >
                                        {processing ? 'Creating...' : 'Create Vacancy'}
                                    </button>
                                </div>
                            </form>
                        </div>
